    ...
    , TOP{this, namep}
{
    ...
    // Setup scopes
    __Vscope_tb_alu.configure(this, name(), "tb_alu", "tb_alu", "<null>", -12, VerilatedScope::SCOPE_OTHER);
    __Vscope_tb_alu__check.configure(this, name(), "tb_alu.check", "check", "<null>", -12, VerilatedScope::SCOPE_OTHER);
}
