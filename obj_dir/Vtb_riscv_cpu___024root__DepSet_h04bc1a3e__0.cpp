...
VL_INLINE_OPT VlCoroutine Vtb_riscv_cpu___024root___eval_initial__TOP__Vtiming__1(Vtb_riscv_cpu___024root* vlSelf) {
    ...
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "tb/tb_riscv_cpu.sv", 
                                         60);
    VL_WRITEF_NX("PC=%0# INST=%x x7=%0#\n",0,32,vlSelfRef.tb_riscv_cpu__DOT__pc,
                 32,vlSelfRef.tb_riscv_cpu__DOT__instruction,
                 32,vlSelfRef.tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__rf__DOT__registers
                 [7U]);
    if (VL_UNLIKELY((0xaU != vlSelfRef.tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__rf__DOT__registers
                     [5U]))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_riscv_cpu.sv:70: Assertion failed in %Ntb_riscv_cpu\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("tb/tb_riscv_cpu.sv", 70, "", false);
    }
    if (VL_UNLIKELY((0x14U != vlSelfRef.tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__rf__DOT__registers
                     [6U]))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_riscv_cpu.sv:73: Assertion failed in %Ntb_riscv_cpu\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("tb/tb_riscv_cpu.sv", 73, "", false);
    }
    if (VL_UNLIKELY((0x1eU != vlSelfRef.tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__rf__DOT__registers
                     [7U]))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_riscv_cpu.sv:76: Assertion failed in %Ntb_riscv_cpu\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("tb/tb_riscv_cpu.sv", 76, "", false);
    }
    VL_WRITEF_NX("\nPASS: Program executed automatically\nx5 = 10\nx6 = 20\nx7 = 30\n==============================\n      CPU PROGRAM PASS\n==============================\n",0);
    VL_FINISH_MT("tb/tb_riscv_cpu.sv", 88, "");
}
