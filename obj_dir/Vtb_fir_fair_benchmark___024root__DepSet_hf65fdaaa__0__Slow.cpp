...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___eval_static(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___eval_initial__TOP(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___eval_initial__TOP\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    VL_READMEM_N(true, 32, 256, 0, VL_CVT_PACK_STR_NW(5, __Vtemp_1)
                 ,  &(vlSelfRef.tb_fir_fair_benchmark__DOT__dut__DOT__imem__DOT__memory)
                 , 0, ~0ULL);
}

VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___eval_final(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___eval_final\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___dump_triggers__stl(Vtb_fir_fair_benchmark___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vtb_fir_fair_benchmark___024root___eval_phase__stl(Vtb_fir_fair_benchmark___024root* vlSelf);

VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___eval_settle(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___eval_settle\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#ifdef VL_DEBUG
            Vtb_fir_fair_benchmark___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("tb/tb_fir_fair_benchmark.sv", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vtb_fir_fair_benchmark___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___dump_triggers__stl(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___dump_triggers__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___stl_sequent__TOP__0(Vtb_fir_fair_benchmark___024root* vlSelf);

VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___eval_stl(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___eval_stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vtb_fir_fair_benchmark___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___stl_sequent__TOP__0(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___stl_sequent__TOP__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___eval_triggers__stl(Vtb_fir_fair_benchmark___024root* vlSelf);

VL_ATTR_COLD bool Vtb_fir_fair_benchmark___024root___eval_phase__stl(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___eval_phase__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vtb_fir_fair_benchmark___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vtb_fir_fair_benchmark___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___dump_triggers__act(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___dump_triggers__act\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb_fir_fair_benchmark.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___dump_triggers__nba(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___dump_triggers__nba\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb_fir_fair_benchmark.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_fir_fair_benchmark___024root___ctor_var_reset(Vtb_fir_fair_benchmark___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_fir_fair_benchmark__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fir_fair_benchmark___024root___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->tb_fir_fair_benchmark__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__reset = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__pc = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__alu_result = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__fir_done = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__branch_type = VL_RAND_RESET_I(2);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__jump = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__immediate = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__branch_target = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__imem__DOT__memory[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__rd_addr = VL_RAND_RESET_I(5);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__reg_write = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__mem_write = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__mem_to_reg = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__lui = VL_RAND_RESET_I(1);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__rs2_data = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__rf__DOT__registers[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir_read_data = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir_write_en = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__ram__DOT__memory[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__sample_in = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff0 = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff1 = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff2 = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff3 = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__delay0 = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__delay1 = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__delay2 = VL_RAND_RESET_I(32);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__accumulator = VL_RAND_RESET_Q(64);
    vlSelf->tb_fir_fair_benchmark__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__result = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigprevexpr___TOP__tb_fir_fair_benchmark__DOT__clk__0 = VL_RAND_RESET_I(1);
}
