...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vtb_decoder___024root___dump_triggers__stl(Vtb_decoder___024root* vlSelf);
#endif  // VL_DEBUG
...
#ifdef VL_DEBUG
            Vtb_decoder___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("tb/tb_decoder.sv", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vtb_decoder___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void Vtb_decoder___024root___eval_triggers__stl(Vtb_decoder___024root* vlSelf);
...
VL_ATTR_COLD bool Vtb_decoder___024root___eval_phase__stl(Vtb_decoder___024root* vlSelf) {
    ...
    // Body
    Vtb_decoder___024root___eval_triggers__stl(vlSelf);
...
VL_ATTR_COLD void Vtb_decoder___024root___dump_triggers__nba(Vtb_decoder___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_decoder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_decoder___024root___dump_triggers__nba\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtb_decoder___024root___ctor_var_reset(Vtb_decoder___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->tb_decoder__DOT__instruction = VL_RAND_RESET_I(32);
    vlSelf->tb_decoder__DOT__rs1_addr = VL_RAND_RESET_I(5);
    vlSelf->tb_decoder__DOT__rs2_addr = VL_RAND_RESET_I(5);
    vlSelf->tb_decoder__DOT__rd_addr = VL_RAND_RESET_I(5);
