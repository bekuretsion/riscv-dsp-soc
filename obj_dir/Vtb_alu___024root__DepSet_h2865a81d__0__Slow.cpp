...
#endif
            VL_FATAL_MT("tb/tb_alu.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_alu___024root___ctor_var_reset(Vtb_alu___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->tb_alu__DOT__a = VL_RAND_RESET_I(32);
    vlSelf->tb_alu__DOT__b = VL_RAND_RESET_I(32);
    vlSelf->tb_alu__DOT__alu_ctrl = VL_RAND_RESET_I(4);
    vlSelf->tb_alu__DOT__result = VL_RAND_RESET_I(32);
    }
