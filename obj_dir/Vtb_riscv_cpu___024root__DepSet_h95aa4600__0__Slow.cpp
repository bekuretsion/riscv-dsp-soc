...
VL_ATTR_COLD void Vtb_riscv_cpu___024root___eval_initial__TOP(Vtb_riscv_cpu___024root* vlSelf) {
    ...
    __Vtemp_1[2U] = 0x6669725fU;
    __Vtemp_1[3U] = 0x616d732fU;
    __Vtemp_1[4U] = 0x726f6772U;
    __Vtemp_1[5U] = 0x70U;
...
VL_ATTR_COLD void Vtb_riscv_cpu___024root___ctor_var_reset(Vtb_riscv_cpu___024root* vlSelf) {
    ...
    vlSelf->tb_riscv_cpu__DOT__instruction = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__alu_result = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__fir_done = VL_RAND_RESET_I(1);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__branch_type = VL_RAND_RESET_I(2);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__jump = VL_RAND_RESET_I(1);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__immediate = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__lui = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir_read_data = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir_write_en = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__ram__DOT__memory[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__sample_in = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff0 = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff1 = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff2 = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__coeff3 = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__delay0 = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__delay1 = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__delay2 = VL_RAND_RESET_I(32);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__accumulator = VL_RAND_RESET_Q(64);
    vlSelf->tb_riscv_cpu__DOT__dut__DOT__core__DOT__dp__DOT__mmio__DOT__fir__DOT__result = VL_RAND_RESET_I(32);
